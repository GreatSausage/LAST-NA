...
Public Class CRDepartmentList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCPMS.CRDepartmentList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRDepartmentList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRDepartmentList = New CRDepartmentList()
        rpt.Site = Me.Site
        Return rpt
    End Function
